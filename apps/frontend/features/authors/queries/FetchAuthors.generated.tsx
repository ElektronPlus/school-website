...
export function useFetchAuthorsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<FetchAuthorsQuery, FetchAuthorsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<FetchAuthorsQuery, FetchAuthorsQueryVariables>(FetchAuthorsDocument, options);
        }
...
export type FetchAuthorsSuspenseQueryHookResult = ReturnType<typeof useFetchAuthorsSuspenseQuery>;
