...
export type FetchAuthorQueryVariables = Types.Exact<{
 ...
 * });
 */
export function useFetchAuthorQuery(baseOptions: Apollo.QueryHookOptions<FetchAuthorQuery, FetchAuthorQueryVariables>) {
