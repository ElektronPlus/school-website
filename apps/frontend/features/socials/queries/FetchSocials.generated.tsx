...
import { SocialFragmentDoc } from '../fragment/Social.generated';
...
export type FetchSocialsQueryVariables = Types.Exact<{ [key: string]: never; }>;
...
export const FetchSocialsDocument = gql`
    query FetchSocials {
  socials {
    data {
      attributes {
...
/**
 * __useFetchSocialsQuery__
 *
 * To run a query within a React component, call `useFetchSocialsQuery` and pass it any options that fit your needs.
 * When your component renders, `useFetchSocialsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useFetchSocialsQuery({
 *   variables: {
 *   },
 * });
 */
export function useFetchSocialsQuery(baseOptions?: Apollo.QueryHookOptions<FetchSocialsQuery, FetchSocialsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<FetchSocialsQuery, FetchSocialsQueryVariables>(FetchSocialsDocument, options);
      }
export function useFetchSocialsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FetchSocialsQuery, FetchSocialsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<FetchSocialsQuery, FetchSocialsQueryVariables>(FetchSocialsDocument, options);
        }
export function useFetchSocialsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<FetchSocialsQuery, FetchSocialsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<FetchSocialsQuery, FetchSocialsQueryVariables>(FetchSocialsDocument, options);
        }
export type FetchSocialsQueryHookResult = ReturnType<typeof useFetchSocialsQuery>;
export type FetchSocialsLazyQueryHookResult = ReturnType<typeof useFetchSocialsLazyQuery>;
export type FetchSocialsSuspenseQueryHookResult = ReturnType<typeof useFetchSocialsSuspenseQuery>;
export type FetchSocialsQueryResult = Apollo.QueryResult<FetchSocialsQuery, FetchSocialsQueryVariables>;