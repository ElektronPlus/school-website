...
export function useFetchNewestEventSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<FetchNewestEventQuery, FetchNewestEventQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<FetchNewestEventQuery, FetchNewestEventQueryVariables>(FetchNewestEventDocument, options);
        }
...
export type FetchNewestEventSuspenseQueryHookResult = ReturnType<typeof useFetchNewestEventSuspenseQuery>;
