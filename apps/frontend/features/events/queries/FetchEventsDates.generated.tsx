...
export type FetchEventsDatesQueryVariables = Types.Exact<{ [key: string]: never; }>;
...
export const FetchEventsDatesDocument = gql`
    query FetchEventsDates {
  events {
    data {
      attributes {
        date
...
/**
 * __useFetchEventsDatesQuery__
 *
 * To run a query within a React component, call `useFetchEventsDatesQuery` and pass it any options that fit your needs.
 * When your component renders, `useFetchEventsDatesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useFetchEventsDatesQuery({
 *   variables: {
 *   },
 * });
 */
export function useFetchEventsDatesQuery(baseOptions?: Apollo.QueryHookOptions<FetchEventsDatesQuery, FetchEventsDatesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<FetchEventsDatesQuery, FetchEventsDatesQueryVariables>(FetchEventsDatesDocument, options);
      }
export function useFetchEventsDatesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FetchEventsDatesQuery, FetchEventsDatesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<FetchEventsDatesQuery, FetchEventsDatesQueryVariables>(FetchEventsDatesDocument, options);
        }
export function useFetchEventsDatesSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<FetchEventsDatesQuery, FetchEventsDatesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<FetchEventsDatesQuery, FetchEventsDatesQueryVariables>(FetchEventsDatesDocument, options);
        }
export type FetchEventsDatesQueryHookResult = ReturnType<typeof useFetchEventsDatesQuery>;
export type FetchEventsDatesLazyQueryHookResult = ReturnType<typeof useFetchEventsDatesLazyQuery>;
export type FetchEventsDatesSuspenseQueryHookResult = ReturnType<typeof useFetchEventsDatesSuspenseQuery>;
export type FetchEventsDatesQueryResult = Apollo.QueryResult<FetchEventsDatesQuery, FetchEventsDatesQueryVariables>;