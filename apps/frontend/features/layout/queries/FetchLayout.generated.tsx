...
import { LayoutFragmentDoc } from '../fragment/Layout.generated';
...
export type FetchLayoutQueryVariables = Types.Exact<{ [key: string]: never; }>;
...
export const FetchLayoutDocument = gql`
    query FetchLayout {
  layout {
    data {
      attributes {
...
/**
 * __useFetchLayoutQuery__
 *
 * To run a query within a React component, call `useFetchLayoutQuery` and pass it any options that fit your needs.
 * When your component renders, `useFetchLayoutQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useFetchLayoutQuery({
 *   variables: {
 *   },
 * });
 */
export function useFetchLayoutQuery(baseOptions?: Apollo.QueryHookOptions<FetchLayoutQuery, FetchLayoutQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<FetchLayoutQuery, FetchLayoutQueryVariables>(FetchLayoutDocument, options);
      }
export function useFetchLayoutLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FetchLayoutQuery, FetchLayoutQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<FetchLayoutQuery, FetchLayoutQueryVariables>(FetchLayoutDocument, options);
        }
export function useFetchLayoutSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<FetchLayoutQuery, FetchLayoutQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<FetchLayoutQuery, FetchLayoutQueryVariables>(FetchLayoutDocument, options);
        }
export type FetchLayoutQueryHookResult = ReturnType<typeof useFetchLayoutQuery>;
export type FetchLayoutLazyQueryHookResult = ReturnType<typeof useFetchLayoutLazyQuery>;
export type FetchLayoutSuspenseQueryHookResult = ReturnType<typeof useFetchLayoutSuspenseQuery>;
export type FetchLayoutQueryResult = Apollo.QueryResult<FetchLayoutQuery, FetchLayoutQueryVariables>;