...
export function useFetchAlertSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<FetchAlertQuery, FetchAlertQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<FetchAlertQuery, FetchAlertQueryVariables>(FetchAlertDocument, options);
        }
...
export type FetchAlertSuspenseQueryHookResult = ReturnType<typeof useFetchAlertSuspenseQuery>;
