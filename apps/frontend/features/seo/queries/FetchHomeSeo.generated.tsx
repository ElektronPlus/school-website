...
import { SeoFragmentDoc } from '../fragments/SEO.generated';
...
export type FetchHomeSeoQueryVariables = Types.Exact<{ [key: string]: never; }>;
...
export const FetchHomeSeoDocument = gql`
    query FetchHomeSeo {
  home {
    data {
      attributes {
...
/**
 * __useFetchHomeSeoQuery__
 *
 * To run a query within a React component, call `useFetchHomeSeoQuery` and pass it any options that fit your needs.
 * When your component renders, `useFetchHomeSeoQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useFetchHomeSeoQuery({
 *   variables: {
 *   },
 * });
 */
export function useFetchHomeSeoQuery(baseOptions?: Apollo.QueryHookOptions<FetchHomeSeoQuery, FetchHomeSeoQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<FetchHomeSeoQuery, FetchHomeSeoQueryVariables>(FetchHomeSeoDocument, options);
      }
export function useFetchHomeSeoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FetchHomeSeoQuery, FetchHomeSeoQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<FetchHomeSeoQuery, FetchHomeSeoQueryVariables>(FetchHomeSeoDocument, options);
        }
export function useFetchHomeSeoSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<FetchHomeSeoQuery, FetchHomeSeoQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<FetchHomeSeoQuery, FetchHomeSeoQueryVariables>(FetchHomeSeoDocument, options);
        }
export type FetchHomeSeoQueryHookResult = ReturnType<typeof useFetchHomeSeoQuery>;
export type FetchHomeSeoLazyQueryHookResult = ReturnType<typeof useFetchHomeSeoLazyQuery>;
export type FetchHomeSeoSuspenseQueryHookResult = ReturnType<typeof useFetchHomeSeoSuspenseQuery>;
export type FetchHomeSeoQueryResult = Apollo.QueryResult<FetchHomeSeoQuery, FetchHomeSeoQueryVariables>;