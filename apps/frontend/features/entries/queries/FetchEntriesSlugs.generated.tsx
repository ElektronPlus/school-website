...
export function useFetchEntriesSlugsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<FetchEntriesSlugsQuery, FetchEntriesSlugsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<FetchEntriesSlugsQuery, FetchEntriesSlugsQueryVariables>(FetchEntriesSlugsDocument, options);
        }
...
export type FetchEntriesSlugsSuspenseQueryHookResult = ReturnType<typeof useFetchEntriesSlugsSuspenseQuery>;
