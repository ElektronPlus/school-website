...
export function useFetchEntrySuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<FetchEntryQuery, FetchEntryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<FetchEntryQuery, FetchEntryQueryVariables>(FetchEntryDocument, options);
        }
...
export type FetchEntrySuspenseQueryHookResult = ReturnType<typeof useFetchEntrySuspenseQuery>;
